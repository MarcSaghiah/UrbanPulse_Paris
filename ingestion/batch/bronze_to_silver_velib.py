...
def run(bronze_bucket: str, silver_bucket: str, region: str) -> str:
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Transform Velib bronze JSON to silver Parquet")
    parser.add_argument("--bronze-bucket", default=os.getenv("S3_BRONZE_BUCKET", ""))
